...
class MailingContact(models.Model):
    ...
    def write(self, vals):
        ...
        print(vals,'vvvvvvvvvvvvvvvv')
        # print('rererererererer',vals, vals.get('tag_ids')[0][0],self.read())
        if 'email' in vals:
    ...
    def send_double_opt_in_email(self):
        ...
        for tag in self.category_ids:
            print('aaaaaaaaaaaaaaasss22222222222222222', tag)
            if tag.send_double_opt_in and conf_send_double_opt_in:
                print(tag, 'kkkkkkkkkkkkkkkkk')
